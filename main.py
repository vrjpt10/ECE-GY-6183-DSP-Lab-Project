...
R2 = Tk.Radiobutton(root, text = "DIY Note", variable = var, value = 'DIY',
                    command = handler)
S1 = Tk.Scale(root, label = 'f0 if DIY notes', variable = f0, from_ = 150, to = 450, tickinterval = 1)
S2 = Tk.Scale(root, label = 'Volume(%)', variable = f1, from_ = 0.0, to = 100.0, tickinterval = 1)
...
R5 = Tk.Radiobutton(root, text = "Vibrato Effect", variable = var1, value = 'Vibrato',
                    command = handler1)
S3 = Tk.Scale(root, label = 'Vibrato Parameter W (W=0 no vibrato)', variable = f2, from_ = 0.0, to = 1.0, resolution = 0.01)
...
R6 = Tk.Radiobutton(root, text = "Set Parameters Above First", variable = var2, value = 'Close',
                    command = handler2)
